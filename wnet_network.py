...
from tensorflow.keras.layers import Input, Conv2D, Lambda,MaxPooling2D, concatenate, UpSampling2D,Add, BatchNormalization
...
def wnet(mu1, sigma1, mu2, sigma2, H=256, W=256, channels=2, kshape=(5, 5), kshape2=(3, 3)):
...
if __name__ == "__main__":
    ...
    model = wnet(stats[0],stats[1],stats[2],stats[3],kshape = (5,5),kshape2=(3,3))
    print(model.summary())